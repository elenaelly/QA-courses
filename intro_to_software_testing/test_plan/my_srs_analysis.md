...
> Тест-кейсы:
> 77) количество ударов больше номинала - 0 очков
> 78) количество ударов равно номиналу - 1 очко
> 79) количество ударов на 1 меньше номинала - 2 очка
> 80) количество ударов на 2 меньше номинала - 4 очка
> 81) количество ударов на 3 меньше номинала - 6 очков
> 82) количество ударов на 4 меньше номинала - 6 очков
...
> Тест-кейсы:
> 83) Golfscore принимает форматированный файл
> 84) Форматированный файл содержит записи в указанном порядке
> 85) Имя входного файла указывается в качестве параметра в строке вызова программы.
...
> Тест-кейсы:
> 86) Для каждого поля для гольфа установлен один рекорд поля.
> 87) Каждая запись содержит название поля, идентификатор для записей игроков в гольф и номинал для каждой из его 18 лунок.
> 88) Все записи курса идут первыми во входном файле.
...
> Тест-кейсы:
> 89) Конец записей курса обозначен записью-разделителем в следующем формате.
...
> Тест-кейсы:
> 90) Рекорд Игрока - рекорд для каждого игрока в гольф на каждом сыгранном поле
...
> Тест-кейсы:
> 90) Конец записей игрока определяется записью-разделителем.
> 91) Конец входного файла определяется записью-разделителем.
